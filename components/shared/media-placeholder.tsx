      ...
      <div
        className={cn(
          ...
          isDark
            ...
            : "border-[#0b1330]/20 bg-white/50 text-[#0b1330]/40"
        )}
      >
        {isVideo ? (
          <span
            className={cn(
              ...
              isDark ? "bg-foreground/10" : "bg-[#0b1330]/10"
            )}
          >
        ...
        {!isVideo && (
          <p
            className={cn(
              ...
              isDark ? "text-muted-foreground/70" : "text-[#0b1330]/35"
            )}
          >
            {media.alt}
          </p>
      ...
      {media.caption && (
        <figcaption
          className={cn(
            ...
            isDark ? "text-muted-foreground" : "text-[#0b1330]/50"
          )}
        >
          {media.caption}
        </figcaption>
