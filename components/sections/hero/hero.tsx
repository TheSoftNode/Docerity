...
function Hero() {
  return (
    <section className="relative overflow-hidden border-b border-border/80">
      ...
      */}
      <Container className="relative grid gap-12 pt-12 pb-16 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:gap-12 lg:pt-20 lg:pb-24 xl:gap-16">
        <div className="flex flex-col">
          ...
          <p className="font-mono text-xs tracking-[0.12em] text-brand-iris uppercase sm:tracking-[0.2em]">
            ...
            <span className="whitespace-nowrap">Tech Explainers</span>
          </p>
          ...
          */}
          <h1 className="mt-6 max-w-[20ch] text-balance font-heading text-[clamp(2rem,6vw,3rem)] font-semibold leading-[1.05] tracking-tight text-foreground lg:mt-7 lg:max-w-none lg:text-[clamp(2.6rem,3.3vw,3.5rem)]">
          ...
          <p className="mt-6 max-w-[46ch] text-pretty text-base leading-[1.75] text-muted-foreground lg:mt-8">
